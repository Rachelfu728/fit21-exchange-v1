...
const segments = [
  { label: "蛋白質棒 ×1", img: "./assets/reward_snackbar_512.png" },
  { label: "活力錠 ×1", img: "./assets/reward_liftoff_512.png" },
  { label: "優護飲 ×1包", img: "./assets/reward_wellnessplus_512.png" },
  { label: "全家美式咖啡 ×1杯", img: "./assets/reward_coffee_512.png" },
  { label: "現金獎 NT$100", img: "./assets/reward_cash100_512.png" },
  { label: "爆脂茶 ×1份（特別獎）", img: "./assets/reward_fatburntea_512.png" },
  { label: "賀寶芙顧客日門票 ×1張", img: "./assets/reward_customerday_ticket_512.png" },
];
...
loadImages()
  ...
  .catch(() => {
    resultEl.textContent = "圖片載入失敗：請確認 assets 路徑與檔名是否正確。";
  });
